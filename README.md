...
- [Проект SQL practice shop db](#-------sql-practice-shop-db)
  * [Таблицы](#-------)
    + [Схема таблиц](#------------)
- [Необходимая теория по SQL](#----------------------sql)
  * [Уровень 1 — Базовые выборки и фильтрация](#--------1-------------------------------)
    + [Основные команды:](#-----------------)
    + [Типовые задачи](#--------------)
    + [Пример](#------)
  * [Уровень 2 — Агрегации и группировка](#--------2--------------------------)
    + [Теория](#------)
    + [Типовые задачи](#---------------1)
    + [Пример](#-------1)
  * [Уровень 3 — Работа с JOIN и агрегатами по связанным таблицам](#--------3------------join-----------------------------------)
    + [Теория](#-------1)
    + [Типовые задачи](#---------------2)
    + [Пример](#-------2)
  * [Уровень 4 — Подзапросы и оконные функции](#--------4-------------------------------)
    + [Теория](#-------2)
      - [Подзапросы (`Subquery`, `CTE`, коррелированные)](#-------------subquery----cte-------------------)
      - [Коррелированные подзапросы ссылаются на строки внешнего запроса:](#----------------------------------------------------------------)
      - [Оконные функции (AVG() OVER (...), RANK(), ROW_NUMBER(), DENSE_RANK(), SUM() OVER (...))](#-----------------avg---over-----rank----row-number----dense-rank----sum---over----)
      - [HAVING](#having)
      - [WITH (CTE)](#with--cte-)
      - [ORM (select().subquery(), func.over())](#orm--select--subquery----funcover---)
    + [Типовые задачи](#---------------3)
    + [Пример с оконной функцией (товары дороже среднего по категории)](#---------------------------------------------------------------)
  * [Уровень 5 — Сложные аналитические задачи и продвинутая работа с данными](#--------5--------------------------------------------------------------)
    + [Теория](#-------3)
      - [#### Многошаговая агрегация](#---------------------------)
      - [Продвинутая работа с окнами](#---------------------------)
      - [Ранжирование и TOP-N через RANK(), DENSE_RANK()](#---------------top-n-------rank----dense-rank--)
      - [Корреляция между таблицами](#--------------------------)
      - [Параметризация](#--------------)
      - [Сложные подзапросы и многоуровневые CTE](#------------------------------------cte)
      - [Сочетание агрегатов и оконных функций](#-------------------------------------)
      - [Оконные функции](#---------------)
      - [ORM-инструменты](#orm------------)
    + [Типовые задачи](#---------------4)
    + [Пример: Топ-3 товара в каждой категории по количеству продаж (SQL)](#------------3-------------------------------------------------sql-)
